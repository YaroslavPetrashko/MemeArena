// MIRROR of the SNAP engine — keep in sync with src/lib/game/snap/bossPassives.ts
...
import type { SnapMatchState, SnapLocation } from "./types.ts";
...
import { spawnTokenAt, moveCardToRandomLocation } from "./engineOps.ts";
