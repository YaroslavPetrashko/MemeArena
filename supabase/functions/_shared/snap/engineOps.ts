// MIRROR of the SNAP engine — keep in sync with src/lib/game/snap/engineOps.ts
...
import type { SnapCard, SnapLocation, SnapMatchState } from "./types.ts";
import type { Rng } from "./prng.ts";
import { getSnapCardDef, snapCardPowerAtLevel } from "./data_snapCards.ts";
import { sideCards, setSideCards, isMoveLocked, openSlots, type Side } from "./helpers.ts";
