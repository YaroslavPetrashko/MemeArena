...
export const GAME_MODES: GameMode[] = [
  {
    ...
    description:
      "The main progression mode. Free to enter. Bosses unlock sequentially and later bosses pay more. Earn Coins and MEMEARENA.",
    icon: "swords",
  ...
  },
  {
    ...
    description:
      "A rotating daily boss. One free entry per day; extra entries cost 25 Gems. Score-based reward brackets with weekly leaderboard bonuses.",
    icon: "calendar",
    freeEntriesPerDay: 1,
    entryCost: { gems: 25 },
    unlockLevel: 1,
  ...
  },
  {
    ...
    description:
      "Endless waves of escalating bots. First 3 runs daily are free; extra entries cost 15 Gems. Token rewards only after wave 5 — higher waves pay sharply more.",
    icon: "infinity",
    freeEntriesPerDay: 3,
    entryCost: { gems: 15 },
    unlockLevel: 2,
  ...
  },
  {
    ...
    description:
      "This week: face the Liquidity Vampire. Entry costs 75 Gems. Italian Brainrot cards deal +20% damage. Big MEMEARENA payouts and a special event leaderboard.",
    icon: "zap",
    freeEntriesPerDay: 0,
    entryCost: { gems: 75 },
    unlockLevel: 3,
  ...
  },
  {
    ...
    tagline: "Coming soon",
    description:
      "A future high-stakes mode for endgame players. Entry costs 250 Gems. Requires player level 8+, a deck power threshold, and weekly eligibility.",
    icon: "crown",
    freeEntriesPerDay: 0,
    entryCost: { gems: 250 },
    unlockLevel: 8,
